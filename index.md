...
[Download](/get-started/) the software and have a look at the [API Docs](api-docs.md). Get [support](/support/) if you run into any problems. Please [cite us](/publications/) if you use OpenOCL in you scientific work.
