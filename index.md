...
<div class="content-row">
  ...
  <div class="content-icon">
    ...
    <p>Just [install the package](/get-started/) and you are ready to go.</p>
  </div>
  ...
  <div class="content-icon">
    ...
    <p>Derivatives are calculated automatically using [CasADi](https://web.casadi.org).</p>
  </div>
  ...
  <div class="content-icon">
    ...
    <p>Implement a real-time [predictive controller](/model-predictive-control/) for your physical system.</p>
  </div>
