...
The [examples](https://github.com/JonasKoenemann/optimal-control/tree/master/Examples) and [documentation](/apit-docs/) were updated accordingly. You now define a System as e.g. 
```
